...
replace github.com/shirou/gopsutil/v3 => github.com/shirou/gopsutil/v3 v3.24.5
...
require (
	...
	github.com/milvus-io/milvus/pkg/v2 v2.0.0-20250422183838-6b30e9ae6002 // indirect
