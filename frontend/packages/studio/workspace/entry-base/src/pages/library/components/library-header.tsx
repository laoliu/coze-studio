...
import { IconCozPlus, IconCozWorkflow } from '@coze-arch/coze-design/icons';
import { Button, Menu, Space } from '@coze-arch/coze-design';

import { type LibraryEntityConfig } from '../types';

export const LibraryHeader: React.FC<{
  entityConfigs: LibraryEntityConfig[];
  onOpenWorkflowGenerator?: () => void;
}> = ({ entityConfigs, onOpenWorkflowGenerator }) => {
  console.log(
    '[LibraryHeader] onOpenWorkflowGenerator:',
    !!onOpenWorkflowGenerator,
  );
    ...
    <div className="flex items-center justify-between mb-[16px]">
      ...
      <Space>
        <Button
          ...
          onClick={onOpenWorkflowGenerator || (() => console.log('No handler'))}
          data-testid="workspace.library.header.ai-generate"
        >
